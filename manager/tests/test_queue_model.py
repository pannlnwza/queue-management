...
class QueueModelTests(TestCase):
    ...
    def test_update_estimated_wait_time_per_turn(self):
        ...
        self.assertEqual(self.queue.estimated_wait_time_per_turn,
                         expected_wait_time)
    ...
    def test_get_number_of_participants(self):
        ...
        participant1 = RestaurantParticipant.objects.create(queue=self.queue,
                                                            party_size=2)
        participant2 = RestaurantParticipant.objects.create(queue=self.queue,
                                                            party_size=4)
    ...
    def test_edit_queue(self):
        ...
        self.queue.edit(name='Updated Queue',
                        description='Updated description', is_closed=True,
                        status='busy')
...
class TableModelTests(TestCase):
    ...
    def test_change_party_different_queue(self):
        ...
        different_queue = Queue.objects.create(name='Different Queue',
        ...
        participant1 = RestaurantParticipant.objects.create(queue=self.queue,
                                                            party_size=2)
        participant2 = RestaurantParticipant.objects.create(
            queue=different_queue, party_size=2)
